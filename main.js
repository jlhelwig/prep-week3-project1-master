...
document.getElementById("q3").innerHTML = "Hello " + firstname1 + " and " + firstname2;
}
greeting ("john", "joe");
...
var sixnumbers = [12,16,57,22,8,47];
var sum = 0;
var aver = 0;
function averaged (anything) {
  for (i=0; i<anything.length ; i++)
  sum = sum + anything[i];
    aver = sum / anything.length;
  return aver;};



  document.getElementById("q4").innerHTML = "Average of 6 Numbers "
+ averaged (sixnumbers);
